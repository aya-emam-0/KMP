...
import com.example.lab1.articles.Article
import com.example.lab1.articles.ArticleRaw
...
fun ArticlesListView(articles: List<ArticleRaw>) {
    ...
    LazyColumn(modifier = Modifier.fillMaxSize()) {
        items(articles.size) { articleIndex ->
            ArticleItemView(article = articles[articleIndex])
        }
    }
}
